...
<img src="https://github.com/lakebrains-technologies/Blogs/blob/master/Color_customization/images/Intro.png?raw=true" >
...
- The processing time for each image is high (about 4 seconds for a 1200x1200 image).
    ...
    <img src="https://github.com/lakebrains-technologies/Blogs/blob/master/Color_customization/images/Reducedimg05.jpg?raw=true" style="width:300px">
...
<img src="https://github.com/lakebrains-technologies/Blogs/blob/master/Color_customization/images/Grayscale_image.jpg?raw=true" style="width:300px">
...
<img src="https://github.com/lakebrains-technologies/Blogs/blob/master/Color_customization/images/beforeAfterStacked.jpg?raw=true" style="width:400px">    
...
1. Where the parts to be customized don't overlap with different parts of the same colors.<br>
    <img src="https://github.com/lakebrains-technologies/Blogs/blob/master/Color_customization/images/sport_02.jpg?raw=true" style="width:300px;"/>
2. Here, we saw overlapping(which made the customization a bit difficult).<br>
    <img src="https://github.com/lakebrains-technologies/Blogs/blob/master/Color_customization/images/original_polo.png?raw=true" style="height:300px">
...
It can be solved simply using the ROI selector. All we have to do is select a portion and work with the colors inside it.<br>
   <img src="https://github.com/lakebrains-technologies/Blogs/blob/master/Color_customization/images/ROI.png?raw=true" style="height:300px"><br>

Similarily, we can customize a sport T-shirt.<br>
   <img src="https://github.com/lakebrains-technologies/Blogs/blob/master/Color_customization/images/sport_02_base.jpg?raw=true" style="width:300px;">
...
It is quite complex to solve and requires some manual input. Here, we had to make a mask using coordinates to distinguish between different parts of the same color. Once we give it a precise mask around the areas with similar color, Knn does its job.<br>
    <img src="https://github.com/lakebrains-technologies/Blogs/blob/master/Color_customization/images/demo_polo.png?raw=true" style="height:300px">
